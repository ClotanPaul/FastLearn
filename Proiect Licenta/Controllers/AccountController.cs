...
namespace Proiect_Licenta.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IUserData userDb)
        {
        ...
        public AccountController(IUserData userDataDb)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    userDataDb.CreateUserDataInst(user.Id, user.UserName);
